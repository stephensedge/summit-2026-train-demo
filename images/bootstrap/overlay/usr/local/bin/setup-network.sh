...
retry "nmcli connection modify EXTERNAL_INTERFACE ipv4.method auto ipv4.dns 10.26.100.1 ipv4.dns-priority -100 ipv4.dns-search summit2026.com ipv4.dhcp-send-hostname no ipv6.dhcp-send-hostname no ipv4.dhcp-hostname bootstrap connection.zone external || true"
